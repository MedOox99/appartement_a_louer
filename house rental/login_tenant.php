...
<body>
            ...
            <div class="inputs">
                <div class="div">
                    ...
                    <form action="tr.php" method="post">
                        ...
                        <input class="p2" type="submit" value="Connexion" name="Connexion2">
                    </form>   
                </div>
            </div>
        </section>
    <div class="continue">
        ...
        <div class="images">
            ...
            <a href="#" class="a1"><img src="g.png" alt="google" class="img2" width="25px" height="25px"></a>
        </div>
        <a href="register_owner.php" class="a2">Create a Compte</a>
    </div>
</div>
</main>
</div>
